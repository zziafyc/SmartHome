...
/**
 * Created by wgyscsf on 2016/7/29.
 * 邮箱：wgyscsf@163.com
...
public class SharePreferenceUtils {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "sharePreference_smarthome";
    ...
    public static <T> Object get(Context context, String key, Class<T> type) {
        SharedPreferences sp = context.getSharedPreferences(FILE_NAME,
                Context.MODE_PRIVATE);
